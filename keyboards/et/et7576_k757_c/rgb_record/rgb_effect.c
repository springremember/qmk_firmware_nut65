...
void rgblight_effect_rainbow_mood(animation_status_t *anim) {
    ...
    for (i = 0; i < rgblight_ranges.effect_num_leds; i++) {
        sethsv(anim->current_hue, 255, rgblight_config.val, (LED_TYPE *)&led[i + rgblight_ranges.effect_start_pos]);
    }
    rgblight_set();
    anim->current_hue++;
}
...
bool rgblight_effect_custom_rainbow_swirl(animation_status_t *anim) {
    ...
    for (i = 0; i < rgblight_ranges.effect_num_leds / 2; i++) {
        ...
        sethsv(hue, 255, rgblight_config.val, (LED_TYPE *)&led[i + rgblight_ranges.effect_start_pos]);
        sethsv(hue, 255, rgblight_config.val, (LED_TYPE *)&led[rgblight_ranges.effect_num_leds - 1 - i + rgblight_ranges.effect_start_pos]);
    }
    rgblight_set();
