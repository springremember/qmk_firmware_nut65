...
#define HS_BT_PIN_STATE                   1, 0
#define HS_2G4_PIN_STATE                  0, 1
...
#define HS_LBACK_TIMEOUT                  (10 * 1000)
#define HS_PAIR_TIMEOUT                   (60 * 1000) // bt
#define HS_PAIR_TIMEOUT1                  (60 * 1000) // 2.4g
#define HS_SLEEP_TIMEOUT                  (3 * 60000)  //(1 * 60000) 
#define HS_WIRESS_SLEEP_TIME              (30)  // 无线设备深度休眠时间：1~30min
