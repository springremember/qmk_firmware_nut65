...
void housekeeping_task_user(void) { // loop
    ...
    if (host_keyboard_led_state().caps_lock){
        rgb_matrix_set_color(HS_RGB_INDEX_CAPS,0x50,0x50,0x50);
    }
...
void rgb_blink_dir(void) {
    rgb_matrix_hs_indicator_set(88, (RGB){0xFF, 0xFF, 0xFF}, 250, 3);
    rgb_matrix_hs_indicator_set(87, (RGB){0xFF, 0xFF, 0xFF}, 250, 3);
    rgb_matrix_hs_indicator_set(89, (RGB){0xFF, 0xFF, 0xFF}, 250, 3);
    rgb_matrix_hs_indicator_set(75, (RGB){0xFF, 0xFF, 0xFF}, 250, 3);
}
...
bool rgb_matrix_indicators_advanced_kb(uint8_t led_min, uint8_t led_max) {
    ...
    if (!keymap_is_mac_system() && keymap_config.no_gui && !rgbrec_is_started()){
        rgb_matrix_set_color(HS_RGB_INDEX_WIN_LOCK, 0x50,0x50,0x50);   
    }
