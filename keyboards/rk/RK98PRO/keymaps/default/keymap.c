...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT( /* Base */
        KC_ESC,   KC_MYCM,   KC_WHOM,  KC_MAIL,  KC_CALC,  KC_MSEL,  KC_MSTP,  KC_MPRV,  KC_MPLY,  KC_MNXT,    KC_MUTE,  KC_VOLD,   KC_VOLU,  RGB_MOD,   RGB_HUI,  RP_END,  KC_SCRL, KC_PAUSE, KC_END,
        KC_GRV,   RP_P0,     RP_P1,    RP_P2,    KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,       KC_0,     KC_MINS,   KC_EQL,   KC_BSPC,             KC_NUM,  KC_PSLS, KC_PAST,  KC_PMNS,
        KC_TAB,   KC_BT1,    KC_BT2,   KC_BT3,   KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     MO(_FBL),   KC_2G4,   KC_LBRC,   KC_RBRC,  KC_BSLS,             KC_P7,   KC_P8,   KC_P9,    KC_PPLS,
        KC_CAPS,  KC_NO,     TO(_MBL), KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     MO(_FBL),   KC_SCLN,  KC_QUOT,             HS_BATQ,             KC_P4,   KC_P5,   KC_P6,  
        KC_LSFT,  KC_Z,      KC_X,     KC_C,     KC_V,     NK_TOGG,  KC_N,     KC_M,     KC_COMM,  KC_DOT,      KC_SLSH,             MO(_FBL),           RGB_VAI,  KC_P1,   KC_P2,   KC_P3,    KC_PENT,  
        KC_LCTL,  GU_TOGG,   KC_LALT,                      EE_CLR,                                 KC_RALT,    _______,             KC_RCTL,  RGB_SPD,   RGB_VAD,  RGB_SPI, KC_P0,   KC_PDOT         ), 
    ...
    [_MBL] = LAYOUT( /* Base */
        ...
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,       KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,             KC_ENT ,             KC_P4,    KC_P5,     KC_P6,
        KC_LSFT,  KC_Z,     KC_X,     KC_C,     KC_V,       KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,             KC_RSFT,             KC_UP,    KC_P1,    KC_P2,     KC_P3,   KC_PENT,
        KC_LCTL,  KC_LALT,  KC_LGUI,                        KC_SPC,                                 KC_RGUI,  MO(_MFL),            KC_RCTL,  KC_LEFT,   KC_DOWN,  KC_RGHT,  KC_P0,     KC_PDOT        ),

    [_MFL] = LAYOUT( /* Base */
        KC_ESC,   KC_BRID,   KC_BRIU, LCTL(KC_UP), LGUI(KC_D), RGB_VAD, RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,    KC_MUTE,  KC_VOLD,   KC_VOLU,  RGB_MOD,   RGB_HUI,  RP_END,  KC_SCRL, KC_PAUSE, KC_END,
        KC_GRV,   RP_P0,     RP_P1,   RP_P2,       KC_4,       KC_5,    KC_6,     KC_7,     KC_8,     KC_9,       KC_0,     KC_MINS,   KC_EQL,   KC_BSPC,              KC_NUM,  KC_PSLS, KC_PAST,  KC_PMNS,
        KC_TAB,   KC_BT1,    KC_BT2,  KC_BT3,      KC_R,       KC_T,    KC_Y,     KC_U,     KC_I,     MO(_FBL),   KC_2G4,   KC_LBRC,   KC_RBRC,  KC_BSLS,              KC_P7,   KC_P8,   KC_P9,    KC_PPLS,
        KC_CAPS,  TO(_BL),   KC_NO,   KC_D,        KC_F,       KC_G,    KC_H,     KC_J,     KC_K,     MO(_FBL),   KC_SCLN,  KC_QUOT,             HS_BATQ,              KC_P4,   KC_P5,   KC_P6,  
        KC_LSFT,  KC_Z,      KC_X,    KC_C,        KC_V,       NK_TOGG, KC_N,     KC_M,     KC_COMM,  KC_DOT,     KC_SLSH,             MO(_FBL),            RGB_VAI,  KC_P1,   KC_P2,   KC_P3,    KC_PENT,  
        KC_LCTL,  KC_LALT,   KC_LGUI,                          EE_CLR,                                KC_RALT,    _______,             KC_RCTL,  RGB_SPD,   RGB_VAD,  RGB_SPI, KC_P0,   KC_PDOT   ), 
    [_FBL] = LAYOUT( /* Base */ 
...
const uint16_t PROGMEM rgbrec_default_effects[RGBREC_CHANNEL_NUM][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT(
     ...
     [1] = LAYOUT(
       ________,  HS_RED,   HS_RED,  HS_RED,   ________,  ________,  ________, ________, ________, ________, ________, ________, ________, ________,  ________, ________, ________, ________, ________,
     ...
     [2] = LAYOUT(
        HS_BLUE,  ________,    ________, ________, ________,  ________,  ________, ________, ________, ________, ________, ________, ________, ________,  ________, ________, ________, ________, ________,
