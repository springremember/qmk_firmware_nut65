...
#define HS_LED_EN_PIN                       B9 // LED POWER ENABLE

#define BAT_FULL_PIN                        A15
#define BAT_FULL_STATE                      1

#define MD_BT1_NAME                         "NUT108 BT1"
#define MD_BT2_NAME                         "NUT108 BT2"
#define MD_BT3_NAME                         "NUT108 BT3"
#define MD_DONGLE_PRODUCT                   "NUT108 2.4G WIRELESS"

/* Device Connection RGB Indicator Light Index And Color */
#define HS_RGB_BLINK_INDEX_BT1              2
#define HS_RGB_BLINK_INDEX_BT2              3
#define HS_RGB_BLINK_INDEX_BT3              4
#define HS_RGB_BLINK_INDEX_2G4              5
#define HS_RGB_BLINK_INDEX_USB              6
...
#define HS_MATRIX_BLINK_INDEX_BAT           9
...
/* SIDE_LIGHT */
#define HS_SIDE_LIGHT_EN_PIN                B8 // SIDE LIGHT POWER ENABLE
#define HS_SIDE_LIGHT_SLEEP_PIN             A9 // SIDE LIGHT SLEEP AND WAKE UP PIN
#define HS_SIDE_LIGHT_ON_STATE              1
#define HS_SIDE_LIGHT_MODE_PIN              D2 // SIDE LIGHT MODE PIN
#define HS_SIDE_LIGHT_DEFAULT_MODE_STATE    0
#define HS_SIDE_LIGHT_DEFAULT_TIMER         50
#define HS_SIDE_LIGHT_VAI_TIMER             100
#define HS_SIDE_LIGHT_MAX_MODE              13
...
#define RGB_MATRIX_LED_COUNT (230)
