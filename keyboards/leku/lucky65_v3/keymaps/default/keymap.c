...
// clang-format off
    ...
    [_BL] = LAYOUT( /* win Base */
        ...
        KC_LCTL,  KC_LCMD,    KC_LALT,              KC_SPC,   KC_SPC,             KC_SPC,   HS_MUTE,  KC_RALT,  MO(_FL),    KC_RCTL,  KC_LEFT,  KC_DOWN,   KC_RGHT
        ),  

    [_FL] = LAYOUT( /* win FN */
        EE_CLR,   KC_F1,      KC_F2,      KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,     KC_F11,   KC_F12,   RL_MOD,    _______,
        KC_GRV,   KC_BT1,     KC_BT2,     KC_BT3,   KC_2G4,   KC_USB,   _______,  _______,  _______,  _______,  _______,    _______,  _______,  RGB_MOD,   _______,
        _______,  _______,    _______,    DEB_TOG,  _______,  _______,  KC_SCRL,  KC_PAUS,  KC_HOME,  KC_END,   _______,    _______,  RGB_MOD,  RGB_HUI,   _______,
        _______,              _______,    _______,  _______,  _______,  _______,  _______,  SYS_CUT,  _______,  _______,    _______,  MO(_DEFA),RGB_VAI,   KC_FTOG,
        LED_TOG,  GU_TOGG,    _______,              HS_BATQ,  HS_BATQ,            HS_BATQ,  _______,  _______,  _______,    _______,  RGB_SPD,  RGB_VAD,   RGB_SPI
        ),
    ...
    [_MBL] = LAYOUT(  /* mac Base */
        ...
        KC_CAPS,  KC_A,       KC_S,       KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,    KC_QUOT,  KC_BSLS,  KC_ENT,    KC_PGUP,  
        KC_LSFT,              KC_Z,       KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,     KC_SLSH,  KC_RSFT,  KC_UP,     KC_PGDN,
        KC_LCTL,  KC_LALT,    KC_LCMD,              KC_SPC,   KC_SPC,             KC_SPC,   HS_MUTE,  KC_RCMD,  MO(_MFL),   KC_RCTL,  KC_LEFT,  KC_DOWN,   KC_RGHT
        ),  
    ...
    [_MFL] = LAYOUT(  /*mac FN */
        ...
        _______,  _______,    _______,    DEB_TOG,  _______,  _______,  KC_SCRL,  KC_PAUS,  KC_HOME,  KC_END,   _______,    _______,  RGB_MOD,  RGB_HUI,   _______,
        _______,              _______,    _______,  _______,  _______,  _______,  _______,  SYS_CUT,  _______,  _______,    _______,  MO(_DEFA),RGB_VAI,   KC_FTOG,
        LED_TOG,  _______,    _______,              HS_BATQ,  HS_BATQ,            HS_BATQ,  _______,  _______,  _______,    _______,  RGB_SPD,  RGB_VAD,   RGB_SPI
        ),
