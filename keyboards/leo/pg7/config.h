...
#define HS_LED_BOOSTING_PIN                 B9 // LED BOOSTING,Power boost pin

#define BAT_FULL_PIN                        A15
#define BAT_FULL_STATE                      1

#define HS_RGB_INDICATOR_COUNT              7
#define HS_RGB_BAT_COUNT                    1

/* Device Name Definition */
#define MD_BT1_NAME "PG-7-BT1"
#define MD_BT2_NAME "PG-7-BT2"
#define MD_BT3_NAME "PG-7-BT3"
#define MD_DONGLE_MANUFACTURER "PG-7 2.4G"                     

/* Device Connection RGB Indicator Light Index And Color */
#define HS_RGB_BLINK_INDEX_BT1 6
#define HS_RGB_BLINK_INDEX_BT2 5 
#define HS_RGB_BLINK_INDEX_BT3 4 
#define HS_RGB_BLINK_INDEX_2G4 3 
#define HS_RGB_BLINK_INDEX_USB 2
...
#define RGB_MATRIX_BAT_INDEX_MAP {6, 5, 4, 3, 2}

/* Status Indicator Lamp */
#define HS_MATRIX_BLINK_INDEX_BAT           2
#define HS_RGB_SYSTEM_SWITCH_INDEX          1
