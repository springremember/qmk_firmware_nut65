...
#define HS_RGB_INDICATOR_COUNT              16
#define HS_RGB_BAT_COUNT                    1

/* Device Name Definition */
#define MD_BT1_NAME "DR-6P-BT1"
#define MD_BT2_NAME "DR-6P-BT2"
#define MD_BT3_NAME "DR-6P-BT3"
#define MD_DONGLE_MANUFACTURER "2.4G Dongle"                     

/* Device Connection RGB Indicator Light Index And Color */
#define HS_RGB_BLINK_INDEX_BT1 5
#define HS_RGB_BLINK_INDEX_BT2 4 
#define HS_RGB_BLINK_INDEX_BT3 3 
#define HS_RGB_BLINK_INDEX_2G4 2 
...
#define HS_RGB_SYSTEM_SWITCH_INDEX          0
