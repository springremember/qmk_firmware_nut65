...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_BL] = LAYOUT( /* Base */
        ...
        KC_LCTL,  KC_LCMD,  KC_LALT,                      KC_SPC,                                           KC_RALT,  MO(_FL),            KC_RCMD,  KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    ...
    [_FL] = LAYOUT( /* Base */
        ...
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   KC_2G4,   KC_USB,   _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,  _______,  _______, 
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,   
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  SYS_TOG,  _______,  _______,  _______,  MO(_DEFA),          _______,            _______, 
        _______,  GU_TOGG,  _______,                      HS_BATQ,                                          _______,  _______,            _______,  _______,  _______,  _______,  _______),
    ...
    [_MBL] = LAYOUT( /* Base  !*/
        ...
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,            KC_BSLS,  KC_DEL,   KC_END,   KC_PGDN,
        KC_CAPS,  KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,  KC_BSLS,            KC_ENT,       
        KC_LSFT,  KC_NUBS,  KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,  KC_RSFT,            MO(_MFL),           KC_UP,
        KC_LCTL,  KC_LALT,  KC_LCMD,                      KC_SPC,                                           KC_RCMD,  MO(_MFL),           KC_RALT,  KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),

    [_MFL] = LAYOUT( /* Base */
        EE_CLR,   KC_BRID,  KC_BRIU,  KC_F3,    KC_F4,    RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,            _______,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   KC_2G4,   KC_USB,   _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,  _______,  _______,  _______, 
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,            _______,   
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  SYS_TOG,  _______,  _______,  _______,  MO(_DEFA),          _______,            _______, 
        _______,  _______,  _______,                      HS_BATQ,                                          _______,  _______,            _______,  _______,  _______,  _______,  _______),
