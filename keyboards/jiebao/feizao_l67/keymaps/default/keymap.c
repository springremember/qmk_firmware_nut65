...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT( /* win FN */
        ...
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   KC_2G4,  KC_USB,   _______,  _______,  _______,  _______,  _______,  _______,  _______,  RGB_MOD,  _______,
        _______,  KC_NO,    TO(_MBL), _______,  _______, _______,  _______,  _______,  _______,  _______,  _______,  _______,  RGB_MOD,  _______,  KC_HOME,
        _______,  RGB_TOG,  _______,  _______,  _______, _______,  _______,  _______,  _______,  RGB_HUI,            _______,  MO(_DEFA),RGB_VAI,  KC_END,
