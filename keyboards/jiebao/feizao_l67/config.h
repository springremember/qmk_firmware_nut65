...
#define HS_RGB_INDICATOR_COUNT              14
#define HS_RGB_BAT_COUNT                    1

/* Device Name Definition */
#define MD_BT1_NAME "feizao-5.0"
#define MD_BT2_NAME "feizao-5.1"
#define MD_BT3_NAME "feizao-5.2"
#define MD_DONGLE_MANUFACTURER "feizao67-2.4G"                     

/* Device Connection RGB Indicator Light Index And Color */
#define HS_RGB_BLINK_INDEX_BT1 9
#define HS_RGB_BLINK_INDEX_BT2 10 
#define HS_RGB_BLINK_INDEX_BT3 11 
#define HS_RGB_BLINK_INDEX_2G4 12 
#define HS_RGB_BLINK_INDEX_USB 13

#define HS_LBACK_COLOR_BT1 RGB_WHITE
#define HS_LBACK_COLOR_BT2 RGB_WHITE
#define HS_LBACK_COLOR_BT3 RGB_WHITE
...
#define HS_RGB_BLINK_INDEX_LCTL             4
