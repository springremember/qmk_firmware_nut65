...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_BL] = LAYOUT(
        ...
        KC_LCTL,  KC_LCMD,    KC_LALT,    KC_SPC,             KC_SPC,   KC_SPC,             KC_SPC,   KC_RCTL,  MO(_FL),              KC_LEFT,  KC_DOWN,   KC_RGHT,  KC_P0,    KC_PDOT
        ),  
    ...
    [_FL] = LAYOUT( 
        ...
        _______,  _______,    _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  RL_MOD,    _______,  _______,  _______, _______,
        ...
        _______,  KC_NO,      TO(_MBL),   _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,    _______,  RGB_MOD,  HS_BATQ,   _______,  _______,  _______,
        ...
        _______,  GU_TOGG,    _______,    EE_CLR,             EE_CLR,   EE_CLR,             EE_CLR,   _______,  _______,              RGB_SPD,  RGB_VAD,   RGB_SPI,  _______,  _______
        ),
    ...
    [_MBL] = LAYOUT(  
        ...
        KC_CAPS,  KC_A,       KC_S,       KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,    KC_QUOT,  KC_NUBS,  KC_ENT,    KC_P4,    KC_P5,    KC_P6, 
        KC_LSFT,  KC_Z,       KC_X,       KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,  KC_UP,     KC_P1,    KC_P2,    KC_P3,   KC_PENT,
        KC_LCTL,  KC_LALT,    KC_LCMD,    KC_SPC,             KC_SPC,   KC_SPC,             KC_SPC,   KC_RCTL,  MO(_MFL),             KC_LEFT,  KC_DOWN,   KC_RGHT,  KC_P0,    KC_PDOT
        ),  

    [_MFL] = LAYOUT( 
        _______,  KC_BRID,    KC_BRIU,LCTL(KC_UP),LGUI(KC_TAB),RGB_VAD, RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,    KC_VOLD,  KC_VOLU,  _______,   _______,  _______,  KC_HOME, KC_END,
        _______,  _______,    _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  RL_MOD,    _______,  _______,  _______, _______,
        _______,  KC_BT1,     KC_BT2,     KC_BT3,   _______,  KC_USB,   _______,  _______,  _______,  MO(_DEFA),KC_2G4,     _______,  _______,  RGB_MOD,   _______,  _______,  _______, _______,
        _______,  TO(_BL),    KC_NO,      _______,  _______,  _______,  _______,  _______,  _______,  MO(_DEFA),_______,    _______,  RGB_MOD,  HS_BATQ,   _______,  _______,  _______,
        _______,  RGB_TOG,    LED_TOG,    _______,  _______,  _______,  _______,  _______,  RGB_HUI,  _______,  _______,              MO(_DEFA),RGB_VAI,   _______,  _______,  _______, _______,
        _______,  _______,    _______,    EE_CLR,             EE_CLR,   EE_CLR,             EE_CLR,   _______,  _______,              RGB_SPD,  RGB_VAD,   RGB_SPI,  _______,  _______
        ),

    [_DEFA] = LAYOUT(  
        KC_TILD,  _______,    _______,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,  _______,  QK_BOOT,   _______,  _______,  _______, _______,
