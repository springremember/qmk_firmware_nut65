...
#define HS_RGB_INDICATOR_COUNT              95
#define HS_RGB_BAT_COUNT                    1

/* Device Name Definition */
#define MD_BT1_NAME "L80 5.2_1"
#define MD_BT2_NAME "L80 5.2_2"
#define MD_BT3_NAME "L80 5.2_3"
#define MD_DONGLE_MANUFACTURER "2.4G Dongle"                     

/* Device Connection RGB Indicator Light Index And Color */
#define HS_RGB_BLINK_INDEX_BT1 63
#define HS_RGB_BLINK_INDEX_BT2 62 
#define HS_RGB_BLINK_INDEX_BT3 61 
#define HS_RGB_BLINK_INDEX_2G4 54 
#define HS_RGB_BLINK_INDEX_USB 59
...
#define RGB_MATRIX_BAT_INDEX_MAP {66, 67, 68, 69, 70, 71, 72, 73, 74, 75}

/* Status Indicator Lamp */
#define HS_MATRIX_BLINK_INDEX_BAT           8
#define HS_RGB_INDEX_CAPS                   31
#define HS_RGB_INDEX_WIN_LOCK               1
#define HS_RGB_INDEX_NUM_LOCK               79
#define HS_RGB_BLINK_INDEX_LCTL             0
#define HS_RGB_BLINK_INDEX_VAI              18
#define HS_RGB_BLINK_INDEX_VAD              10
#define HS_RGB_BLINK_INDEX_SPI              11
#define HS_RGB_BLINK_INDEX_SPD              9

#define HS_RGB_BLINK_INDEX_WIN              32
#define HS_RGB_BLINK_INDEX_MAC              33
