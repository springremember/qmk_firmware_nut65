...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_FL] = LAYOUT( /* win FN */
        ...
        _______,  KC_NO,    TO(_MBL), _______,  _______, _______,  _______,  _______,  _______,  _______,  _______,  _______,            HS_BATQ,  KC_HOME,
    ...
    [_MFL] = LAYOUT(
        KC_GRV,   KC_F1,    KC_F2,    KC_F3,    KC_F4,   KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,   _______,  _______,
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   _______, KC_USB,   _______,  _______,  _______,  _______,  KC_2G4,   _______,  _______,  RGB_MOD,  _______,
        _______,  TO(_BL),  KC_NO,    _______,  _______, _______,  _______,  _______,  _______,  _______,  _______,  _______,            HS_BATQ,  KC_HOME,
        _______,  RGB_TOG,  LED_TOG,  _______,  _______, _______,  _______,  _______,  _______,  RGB_HUI,            _______,  MO(_DEFA),RGB_VAI,  KC_END,
    ...
    [_FFL] = LAYOUT( 
        ...
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   _______, KC_USB,   _______,  _______,  _______,  _______,  KC_2G4,   _______,  _______,  RGB_MOD,  _______,
        _______,  KC_NO,    TO(_FMBL),_______,  _______, _______,  _______,  _______,  _______,  _______,  _______,  _______,            HS_BATQ,  KC_HOME,
        _______,  RGB_TOG,  LED_TOG,  _______,  _______, _______,  _______,  _______,  _______,  RGB_HUI,            _______,  MO(_DEFA),RGB_VAI,  KC_END,
        KC_FTOG,  GU_TOGG,  _______,  EE_CLR,   EE_CLR,  EE_CLR,   EE_CLR,                       KC_RCTL,            _______,  RGB_SPD,  RGB_VAD,  RGB_SPI
    ),
    ...
    [_FMFL] = LAYOUT(
        ...
        _______,  KC_BT1,   KC_BT2,   KC_BT3,   _______, KC_USB,   _______,  _______,  _______,  _______,  KC_2G4,   _______,  _______,  RGB_MOD,  _______,
        _______,  TO(_FBL), KC_NO,    _______,  _______, _______,  _______,  _______,  _______,  _______,  _______,  _______,            HS_BATQ,  KC_HOME,
        _______,  RGB_TOG,  LED_TOG,  _______,  _______, _______,  _______,  _______,  _______,  RGB_HUI,            _______,  MO(_DEFA),RGB_VAI,  KC_END,
        KC_FTOG,  _______,  _______,  EE_CLR,   EE_CLR,  EE_CLR,   EE_CLR,                       KC_RCTL,            _______,  RGB_SPD,  RGB_VAD,  RGB_SPI
    ),
